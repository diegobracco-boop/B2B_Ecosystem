...
function _ctryPageCacheKey_(pais, desde, hasta) {
  return JSON.stringify({ v:22, ctry:1, pais:pais, desde:desde, hasta:hasta });
}
...
function getCountryPageData(params) {
  ...
  var key    = _ctryPageCacheKey_(pais, desde, hasta);
